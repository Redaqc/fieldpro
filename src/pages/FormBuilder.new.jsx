...
import { useCreateFormTemplates } from "@/hooks/useFormTemplatess";
...
export default function FormBuilder() {
  ...
  const createFormMutation = useCreateFormTemplates();
  ...
  const handleSave = () => {
    ...
    const backendData = {
      ...
      requireSignature: formData.require_signature,
      autoPdf: formData.auto_pdf,
      isActive: formData.active,
    };

    createFormMutation.mutate(backendData, {
      onSuccess: () => {
                          ...
                          {(provided) => (
                            ...
                            >
                              <div className="flex items-start gap-3">
                                <div {...provided.dragHandleProps} className="mt-8">
